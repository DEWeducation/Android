...
public class PostsActivity extends BaseActivity implements
    ...
    private void getData() {
        ...
        if (FID == 72)
           url = "https://online.inlow.online/dew/myquestion.html";
        else if (FID == 550)
            url = "https://online.inlow.online/dew/myanswer.html";
        else if (FID == 145)
            url = "https://online.inlow.online/dew/paper.html";
        else if (FID == 549)
            url = "https://online.inlow.online/dew/mystar.html";
        else if (FID == 551)
            url = "https://online.inlow.online/dew/videolist.html";
        else if (FID == 115)
            url = "https://online.inlow.online/dew/note.html";
        else
        {
            url = "https://online.inlow.online/dew/none.html";
        }
