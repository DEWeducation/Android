...
public class UserDetailActivity extends BaseActivity implements AddFriendDialog.AddFriendListener {
    ...
    private String imageUrl = "https://online.inlow.online/dew/post1_files/avatar.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this).load(imageUrl).placeholder(R.drawable.image_placeholder1).into(imageView);
